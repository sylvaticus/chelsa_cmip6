...
def chelsa_cmip6(source_id, institution_id, table_id, activity_id, experiment_id, member_id, 
                 refps, refpe, fefps, fefpe, xmin, xmax, ymin, ymax, output, use_esgf=False, node='https://esgf.ceda.ac.uk/esg-search', bio=True):
    """ 
    ...
    :param use_esgf: boolean, Use ESGF node instead of Pangeo, default=False
    :param node: string, address of the ESFG node, default=https://esgf.ceda.ac.uk/esg-search
    :param bio: boolean, wheter to compute the bio variables, default=True
    """
